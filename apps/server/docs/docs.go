    ...
    "paths": {
        ...
        "/live/strategy": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "전략 payload (name, universe, clauses, max_positions, exit_policy, position_size_krw)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/portfolio/discover/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Discover request (동기 버전과 동일 페이로드)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/portfolio/discover/status/{job_id}": {
            "get": {
